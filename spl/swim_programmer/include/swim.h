...
// SDS slechte keuze want deze pinnen kunnen niet veel current leveren
/*
#define SWIM_OUT_PIN      GPIO_Pin_14
#define SWIM_OUT_PORT     GPIOC
//SDS #define RESET_PIN         GPIO_Pin_13 // dit is al de led op bluepill
#define RESET_PIN         GPIO_Pin_15
#define RESET_PORT        GPIOC
*/
#define SWIM_OUT_PIN      GPIO_Pin_10
...
//#define SWIM_LONG_DELAY() {__NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP();__NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP();}	//used for long bit delay

#pragma GCC push_options
#pragma GCC optimize ("O0")
#define SWIM_SHORT_DELAY() {__NOP();} // sds : was 1 nop, 3 for test
#pragma GCC pop_options

#pragma GCC push_options
#pragma GCC optimize ("O3")
#define SWIM_LONG_DELAY() {                \
...
#define DM_CSR2								 0x7F99 // sds, stall bit zit hier
#define SWIM_FLASH             0x00505a // sds : flash peripheral base address
...
#define SWIM_FLASH_PUKR        (SWIM_FLASH + 0x08) // SDS : 0x5062
